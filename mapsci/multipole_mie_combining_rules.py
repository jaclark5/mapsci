"""
multipole_mie_combining_rules.py
...
def mie_integral(sigma0, beadAB):
    ...
    integral = -4*np.pi*beadAB["epsilon"]*prefactor(beadAB["l_r"],beadAB["l_a"])*beadAB["sigma"]**beadAB["l_a"]/sigma0**(beadAB["l_a"]-3) / (beadAB["l_a"] - 3)
